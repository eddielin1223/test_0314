...
class InstallCommand extends Command
{
    ...
    protected function installLivewireStack()
    {
        ...
        // Single Blade Views...
        copy(__DIR__.'/../../stubs/livewire/resources/views/recommendation.blade.php', resource_path('views/recommendation.blade.php'));
        ...
        if (! Str::contains(file_get_contents(base_path('routes/web.php')), "'/recommendation'")) {
            (new Filesystem)->append(base_path('routes/web.php'), $this->livewireRouteDefinition());
        }
...
EOF;
    ...
    protected function installInertiaStack()
    {
        ...
        // Inertia Pages...
        copy(__DIR__.'/../../stubs/inertia/resources/js/Pages/Recommendation.vue', resource_path('js/Pages/Recommendation.vue'));
